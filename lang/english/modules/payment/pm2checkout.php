<?php
/* -----------------------------------------------------------------------------------------
   $Id: pm2checkout.php,v 1.4 2004/04/28 10:51:04 fanta2k Exp $   
...
define('MODULE_PAYMENT_2CHECKOUT_EMAIL_MERCHANT_DESC' , 'Should 2CheckOut eMail a receipt to the store owner?');
