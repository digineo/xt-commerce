...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_INVOICE_TEXT_DESCRIPTION', 'Cash');
  define('MODULE_PAYMENT_INVOICE_TEXT_TITLE', 'Cash');

  define('MODULE_PAYMENT_INVOICE_STATUS_TITLE' , 'Enable Cash Module');
define('MODULE_PAYMENT_INVOICE_STATUS_DESC' , 'Do you want to accept Cash as payments?');
