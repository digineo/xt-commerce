<?php
    /*
        $Id: uos_vorkasse_modul.php 21 2006-12-25 14:31:15Z mzanier $
  ...
  define('MODULE_PAYMENT_UOS_VORKASSE_TEXT_TITLE', '<img src="https://www.united-online-transfer.com/images/_icon_ueberweisung.gif" align="middle" > Vorkasse ');
  define('MODULE_PAYMENT_UOS_VORKASSE_TEXT_DESCRIPTION', 'UOS Vorkasse Modul<br><br><b>!Achtung!</b> Als xt:Commerce User erhalten Sie Sonderkonditionen, Details siehe <a href="http://www.xt-commerce.com/index.php?option=com_content&task=view&id=57&Itemid=75" target="_new">[Link]</a>');
  define('MODULE_PAYMENT_UOS_VORKASSE_MODUL_TEXT_TITLE', '<img src="https://www.united-online-transfer.com/images/_icon_ueberweisung.gif" align="middle" > Vorkasse  ');
  define('MODULE_PAYMENT_UOS_VORKASSE_MODUL_TEXT_DESCRIPTION', 'UOS Vorkasse Modul');
  define('MODULE_PAYMENT_UOS_VORKASSE_1_TITLE', 'Aktiviren U O S Vorkasse');
...
define('MODULE_PAYMENT_UOS_VORKASSE_MODUL_ALLOWED_DESC', 'Geben Sie <b>einzeln</b> die Zonen an, welche f&uuml;r dieses Modul erlaubt sein sollen. (z.B. AT,DE (wenn leer, werden alle Zonen erlaubt))');
