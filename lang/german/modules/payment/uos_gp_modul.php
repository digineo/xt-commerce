<?php
    /*
        $Id: uos_gp_modul.php 21 2006-12-25 14:31:15Z mzanier $
  ...
  define('MODULE_PAYMENT_UOS_GP_CURRENCY_TITLE','Währung');
  ...
  define('MODULE_PAYMENT_UOS_GP_KEY_DESC','Den Security-Key den Sie von U O S zur Segnierung der Datenübertragung bekommen haben.');
  define('MODULE_PAYMENT_UOS_GP_CURRENCY_DESC','Die Währung die Sie bei U O S nutzen möchten.');
  define('MODULE_PAYMENT_UOS_GP_ZONE_DESC','Wenn Sie hiereine Zone einstellen wird diese Payment nur für diese genutzt werden.');
