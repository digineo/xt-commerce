...
------------------------------------------------------------------------------*/
  ...
  define('MODULE_PAYMENT_LIBERECO_CC_TEXT_JS_LIBERECO_CC_OWNER', '* Der Name des Karteninhabers muss aus mindestens' . LIBERECO_CC_OWNER_MIN_LENGTH . ' ZEichen bestehen.\n');
  define('MODULE_PAYMENT_LIBERECO_CC_TEXT_JS_LIBERECO_CC_NUMBER', '* Die Kreditkartennummer muss aus mindestens ' . LIBERECO_CC_NUMBER_MIN_LENGTH . ' Ziffern bestehen.\n');
  define('MODULE_PAYMENT_LIBERECO_CC_TEXT_ERROR', 'Kreditkartenfehler!');
  define('MODULE_PAYMENT_LIBERECO_CC_TEXT_JS_LIBERECO_CC_CVV', 'Der CVV Sicherheitscode ist ein Pflichtfeld und muss ausgef&uuml;llt werden..\n Bestellungen k&ouml;nnen ohne diesen Code nicht ausgef&uuml;hrt werden.\n Der CVV Code besteht aus 3 Ziffern und ist im Unterschriftsfeld auf der R&uuml;ckseite Ihrer Karte gedruckt.');
