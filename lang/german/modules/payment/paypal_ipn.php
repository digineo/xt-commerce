...
define('MODULE_PAYMENT_PAYPAL_IPN_API_ACTIVE_TITLE','Paypal API');
define('MODULE_PAYMENT_PAYPAL_IPN_API_ACTIVE_DESC','API Funktionen aktivieren ?');

define('MODULE_PAYMENT_PAYPAL_IPN_API_USERNAME_TITLE','API Benutzername');
define('MODULE_PAYMENT_PAYPAL_IPN_API_USERNAME_DESC','');
define('MODULE_PAYMENT_PAYPAL_IPN_API_PASSWORD_TITLE','API Passwort');
define('MODULE_PAYMENT_PAYPAL_IPN_API_PASSWORD_DESC','');
define('MODULE_PAYMENT_PAYPAL_IPN_API_SIGNATURE_TITLE','API 128Bit-Signatur');
define('MODULE_PAYMENT_PAYPAL_IPN_API_SIGNATURE_DESC','');


define('MODULE_PAYMENT_PAYPAL_IPN_COST_TITLE', _MODULES_PAYMENT_FEE_TITLE);
define('MODULE_PAYMENT_PAYPAL_IPN_COST_DESC', _MODULES_PAYMENT_FEE_DESC);
define('MODULE_PAYMENT_PAYPAL_IPN_ZONE_TITLE', _MODULES_ZONE_TITLE);
define('MODULE_PAYMENT_PAYPAL_IPN_ZONE_DESC', _MODULES_ZONE_DESC);
define('MODULE_PAYMENT_PAYPAL_IPN_ALLOWED_TITLE', _MODULES_ZONE_ALLOWED_TITLE);
define('MODULE_PAYMENT_PAYPAL_IPN_ALLOWED_DESC', _MODULES_ZONE_ALLOWED_DESC);
define('MODULE_PAYMENT_PAYPAL_IPN_SORT_ORDER_TITLE', _MODULES_SORT_ORDER_TITLE);
define('MODULE_PAYMENT_PAYPAL_IPN_SORT_ORDER_DESC', _MODULES_SORT_ORDER_DESC);
define('MODULE_PAYMENT_PAYPAL_IPN_ORDER_STATUS_ID_TITLE', _MODULES_SET_ORDER_STATUS_TITLE);
define('MODULE_PAYMENT_PAYPAL_IPN_ORDER_STATUS_ID_DESC', _MODULES_SET_ORDER_STATUS_DESC);
?>