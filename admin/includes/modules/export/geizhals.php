<?php
/* -----------------------------------------------------------------------------------------
   $Id: geizhals.php,v 1.4 2004/05/05 18:14:28 fanta2k Exp $
...
define('MODULE_GEIZHALS_TEXT_DESCRIPTION', 'Export - Geizhals.at (; getrennt)<br><b>Format:</b><br>Artikelnr;Hersteller;Bezeichnung;Preis; Verfügbarkeit;deeplink;optionale Beschreibung');
...
// include needed functions
  ...
  class geizhals {
    ...
    return array('text' =>  EXPORT_STATUS_TYPE.'<br>'.
                            ...
                            '<a href="' . xtc_href_link(FILENAME_MODULE_EXPORT, 'set=' . $_GET['set'] . '&module=geizhals') . '">' .
