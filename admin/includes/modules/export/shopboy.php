<?php
/* -----------------------------------------------------------------------------------------
   $Id: shopboy.php,v 1.3 2004/06/06 13:43:02 fanta2k Exp $
...
define('MODULE_SHOPBOY_CURRENCY_TITLE','Währung');
define('MODULE_SHOPBOY_CURRENCY_DESC','Welche Währung soll exportiert werden?');
...
// include needed functions
  ...
  class shopboy {
    ...
    return array('text' =>  EXPORT_STATUS_TYPE.'<br>'.
                            ...
                            '<a href="' . xtc_href_link(FILENAME_MODULE_EXPORT, 'set=' . $_GET['set'] . '&module=shopboy') . '">' .
