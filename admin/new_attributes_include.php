<?php
/* --------------------------------------------------------------
   $Id: new_attributes_include.php,v 1.5 2004/05/31 10:15:35 fanta2k Exp $   
...
<?php
echo xtc_image_submit('button_save.gif','');
echo $backLink.xtc_image_button('button_cancel.gif','').'</a>';
?>
</td>
  </tr>
</form>