<?php
/* --------------------------------------------------------------
   $Id: specials.php,v 1.6 2004/02/29 17:05:18 fanta2k Exp $   
  ...
  switch ($_GET['action']) {
    ...
    default:
      if (is_object($sInfo)) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<br>' . xtc_product_info_image($sInfo->products_image, $sInfo->products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT));
