<?php
/* --------------------------------------------------------------
   $Id: banner_manager.php,v 1.4 2004/02/29 17:05:18 fanta2k Exp $   
  ...
  if ($_GET['action']) {
    switch ($_GET['action']) {
      ...
      case 'update':
        ...
        if (empty($html_text)) {
          if (!$banners_image = &xtc_try_upload('banners_image', DIR_FS_CATALOG_IMAGES.'banner/' . $banners_image_target)) {
            $banner_error = true;
          }
        }
