<?php
/* -----------------------------------------------------------------------------------------
   $Id: ot_gv.php,v 1.3 2004/04/24 14:56:55 fanta2k Exp $
...
//        $gv_order_amount += 0.001;
    ...
    function collect_posts() {
     ...
     if ($_POST['submit_redeem_x'] && $gv_result['coupon_type'] == 'G') xtc_redirect(xtc_href_link(FILENAME_CHECKOUT_PAYMENT, 'error_message=' . urlencode(ERROR_NO_REDEEM_CODE), 'SSL'));
   }
