  ...
  class ipaymentelv {
    ...
    function javascript_validation() {
      $js = '  if (payment_value == "' . $this->code . '") {' . "\n" .
            '    var bank_owner = document.checkout_payment.ipayment_owner.value;' . "\n" .
            '    var bank_name = document.checkout_payment.ipayment_bank_name.value;' . "\n" .
            '    var bank_id = document.checkout_payment.ipayment_bank_code.value;' . "\n" .
            '    var bank_account = document.checkout_payment.ipayment_bank_account.value;' . "\n" .
            '    var bank_iban = document.checkout_payment.ipayment_bank_iban.value;' . "\n" .
    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
                         'module' => $this->title,
                         'fields' => array(array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_OWNER,
                                                 'field' => xtc_draw_input_field('ipayment_owner', $order->billing['firstname'] . ' ' . $order->billing['lastname'])),
                                           array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_NAME,
                                                 'field' => xtc_draw_input_field('ipayment_bank_name')),
                                           array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_BLZ,
                                                 'field' => xtc_draw_input_field('ipayment_bank_code')),
                                           array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_NUMBER,
                                                 'field' => xtc_draw_input_field('ipayment_bank_account')),
                                           array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_IBAN,
                                                 'field' => xtc_draw_input_field('ipayment_bank_iban')),
                                           array('field'=>'&nbsp;<small>' . MODULE_PAYMENT_IPAYMENTELV_TEXT_IBAN . '</small>')));
    ...
    function confirmation() {
      ...
      $confirmation = array('title' => $this->title . ': ',
                            'fields' => array(array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_OWNER,
                                                    'field' => $_POST['ipayment_owner']),
                                              array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_NAME,
                                                    'field' => $_POST['ipayment_bank_name']),
                                              array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_BLZ,
                                                    'field' => $_POST['ipayment_bank_code']),
                                              array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_NUMBER,
                                                    'field' => $_POST['ipayment_bank_account']),
                                              array('title' => MODULE_PAYMENT_IPAYMENTELV_TEXT_BANK_IBAN,
    ...
    function process_button() {
      ...
      $process_button_string = xtc_draw_hidden_field('silent', '1') .
                               ...
                               xtc_draw_hidden_field('bank_name', $_POST['ipayment_bank_name']) .
                               xtc_draw_hidden_field('bank_code', $_POST['ipayment_bank_code']) .
                               xtc_draw_hidden_field('bank_accountnumber', $_POST['ipayment_bank_account']) .
                               xtc_draw_hidden_field('bank_iban', $_POST['ipayment_bank_iban']) .

                               xtc_draw_hidden_field('addr_name', $_POST['ipayment_owner']) .
                               ...
                               xtc_draw_hidden_field('silent_error_url', xtc_href_link(FILENAME_CHECKOUT_PAYMENT, 'payment_error=' . $this->code . '&ipayment_owner=' . urlencode($_POST['ipayment_owner']), 'SSL', true));
    ...
    function get_error() {
      ...
      $error = array('title' => IPAYMENTELV_ERROR_HEADING,
                     'error' => ((isset($_GET['ret_errormsg'])) ? stripslashes(urldecode($_GET['ret_errormsg'])) : IPAYMENTELV_ERROR_MESSAGE));
