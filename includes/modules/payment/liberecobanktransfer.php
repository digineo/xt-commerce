<?php
/* -----------------------------------------------------------------------------------------
   $Id: liberecobanktransfer.php,v 1.2 2004/01/02 00:08:25 fanta2k Exp $
...
// class methods
    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
                         'module' => $this->title,
      	                 'fields' => array(array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_NOTE,
      	                                         'field' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_INFO),
      	                                   array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_OWNER,
      	                                         'field' => xtc_draw_input_field('banktransfer_owner', $order->billing['firstname'] . ' ' . $order->billing['lastname'])),
      	                                   array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_BLZ,
      	                                         'field' => xtc_draw_input_field('banktransfer_blz', '', 'size="8" maxlength="8"')),
      	                                   array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_NUMBER,
      	                                         'field' => xtc_draw_input_field('banktransfer_number', '', 'size="16" maxlength="32"')),
      	                                   array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_NAME,
      ...
      if (MODULE_PAYMENT_LIBERECO_BANKTRANSFER_FAX_CONFIRMATION =='true'){
        $selection['fields'][] = array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_NOTE,
      	                               'field' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_NOTE2 . '<a href="' . MODULE_PAYMENT_LIBERECO_BANKTRANSFER_URL_NOTE . '" target="_blank"><b>' . MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_NOTE3 . '</b></a>' . MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_NOTE4);
      	$selection['fields'][] = array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_FAX,
    ...
    function confirmation() {
      ...
      if (!$_POST['banktransfer_owner'] == '') {
        $confirmation = array('title' => $this->title,
                              'fields' => array(array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_OWNER,
...
//			       xtc_draw_hidden_field('TESTSIGNUP', 'true') .
    ...
    function get_error() {
      ...
      $error = array('title' => MODULE_PAYMENT_LIBERECO_BANKTRANSFER_TEXT_BANK_ERROR,
