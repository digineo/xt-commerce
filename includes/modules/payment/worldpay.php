...
// class methods
      ...
      xtc_draw_hidden_field('instId', MODULE_PAYMENT_WORLDPAY_ID) .
      xtc_draw_hidden_field('currency', $_SESSION['currency']) .
      xtc_draw_hidden_field('desc', 'Purchase from '.STORE_NAME) .
      xtc_draw_hidden_field('cartId', $worldpay_url) .
      xtc_draw_hidden_field('amount', $total);
...
// Ian-san: Create callback and language links here 6/4/2003:
      ...
      $process_button_string .=
        xtc_draw_hidden_field('testMode', MODULE_PAYMENT_WORLDPAY_MODE) .
        ...
        xtc_draw_hidden_field('myvar', 'Y') .
        xtc_draw_hidden_field('fax', $order->customer['fax']) .
...
// Ian-san: Added dynamic callback and languages link here 6/4/2003:
        ...
        xtc_draw_hidden_field('MC_callback', xtc_href_link(wpcallback).'.php') .
        xtc_draw_hidden_field('MC_XTCsid', $XTCsid);
...
// Ian-san: Added MD5 here 6/4/2003:
      if (MODULE_PAYMENT_WORLDPAY_USEMD5 == '1') {
        ...
        $process_button_string .= xtc_draw_hidden_field('signatureFields', $md5_signature_fields ) .
                                  xtc_draw_hidden_field('signature',$md5_signature_md5);
      }
