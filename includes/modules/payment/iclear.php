<?php
/* -----------------------------------------------------------------------------------------
   $Id: iclear.php,v 1.2 2004/06/04 13:07:22 fanta2k Exp $   
...
// class methods
    ...
    function process_button() {
      ...
      $process_button_string = xtc_draw_hidden_field('ShopID', MODULE_PAYMENT_ICLEAR_ID) .
                               xtc_draw_hidden_field('BasketID', xtc_create_random_value(5, 'digits')) .
      ...
      $process_button_string .= xtc_draw_hidden_field('ProductIndex', $i) .
                                xtc_draw_hidden_field('Products', $process_products_string) .
                                xtc_draw_hidden_field('User_Def', '&' . xtc_session_name() . '=' . xtc_session_id());
