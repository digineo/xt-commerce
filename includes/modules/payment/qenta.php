...
// class methods
    ...
    function process_button() {
      ...
      $request_fingerprint = md5(MODULE_PAYMENT_QENTA_MERCHANTKEY.
	  						     ...
	  						     xtc_href_link(FILENAME_CHECKOUT_PROCESS, 'trid='.$this->transaction_id, 'NONSSL', false).
	  						     xtc_href_link(FILENAME_CHECKOUT_PAYMENT, 'payment_error=qenta', 'SSL', true, false).
	  						     xtc_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL', true, false).
	  						     xtc_href_link(FILENAME_CONTACT_US, '', 'NONSSL', true, false).
	  						     MODULE_PAYMENT_QENTA_IMAGEURL.
	  						     MODULE_PAYMENT_QENTA_SECRET);
      ...
      $process_button_string = xtc_draw_hidden_field('merchantKey', MODULE_PAYMENT_QENTA_MERCHANTKEY) .
                               ...
                               xtc_draw_hidden_field('orderDescription', $this->transaction_id.'-'.$order->customer['firstname'].' '.$order->customer['lastname']) .
                               xtc_draw_hidden_field('successURL', xtc_href_link(FILENAME_CHECKOUT_PROCESS, 'trid='.$this->transaction_id, 'NONSSL', false)) .
                               xtc_draw_hidden_field('failureURL', xtc_href_link(FILENAME_CHECKOUT_PAYMENT, 'payment_error=qenta', 'SSL', true, false)) .
                               xtc_draw_hidden_field('cancelURL', xtc_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL', true, false)) .
                               xtc_draw_hidden_field('serviceURL', xtc_href_link(FILENAME_CONTACT_US, '', 'NONSSL', true, false)) .
                               xtc_draw_hidden_field('ImageURL', MODULE_PAYMENT_QENTA_IMAGEURL) .
                               xtc_draw_hidden_field('requestFingerprint', $request_fingerprint).
							   xtc_draw_hidden_field('orderDesc', $this->transaction_id.'-'.$order->customer['firstname'].' '.$order->customer['lastname']);
    ...
    function get_error() {
      ...
      $error = array('title' => MODULE_PAYMENT_QENTA_TEXT_ERROR,
                     'error' => MODULE_PAYMENT_QENTA_ERROR);
