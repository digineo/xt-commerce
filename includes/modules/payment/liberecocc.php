...
// class methods
    ...
    function javascript_validation() {
      $js = '  if (payment_value == "' . $this->code . '") {' . "\n" .
            ...
            '    var cvv_number = document.checkout_payment.cvv_number.value;' . "\n" .
            '    if (cc_owner == "" || cc_owner.length < ' . LIBERECO_CC_OWNER_MIN_LENGTH . ') {' . "\n" .
            '      error_message = error_message + "' . MODULE_PAYMENT_LIBERECO_CC_TEXT_JS_LIBERECO_CC_OWNER . '";' . "\n" .
            '      error = 1;' . "\n" .
            '    }' . "\n" .
            '    if (cc_number == "" || cc_number.length < ' . LIBERECO_CC_NUMBER_MIN_LENGTH . ') {' . "\n" .
            ...
            '      error_message = error_message + "' . MODULE_PAYMENT_LIBERECO_CC_TEXT_JS_CVV_NUMBER . '";' . "\n" .
            '      error = 1;' . "\n" .
            '    }' . "\n" .
    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
                         'module' => $this->title,
                         'fields' => array(array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CREDIT_CARD_OWNER,
                                                 'field' => xtc_draw_input_field('cc_owner', $order->billing['firstname'] . ' ' . $order->billing['lastname'])),
                                           array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CREDIT_CARD_TYPE,
                                                 'field' => xtc_draw_pull_down_menu('cc_type', $card_types)),
                                           array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CREDIT_CARD_NUMBER,
                                                 'field' => xtc_draw_input_field('cc_number')),
                                           array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CVV_NUMBER. ' ' .'<a href="javascript:popupWindow(\'' . xtc_href_link(FILENAME_POPUP_CVV, '', 'SSL') . '\')">' . TEXT_CVV_LINK . '</a>',
                                                 'field' => xtc_draw_input_field('cvv_number')),
                                           array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CREDIT_CARD_EXPIRES,
    ...
    function confirmation() {
      ...
      $confirmation = array('title' => $this->title . ': ' . $this->cc_card_type,
                            'fields' => array(array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CREDIT_CARD_OWNER,
                                              ...
                                              array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CVV_NUMBER,
                                                    'field' => $_POST['cvv_number']),
                                              array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_CREDIT_CARD_EXPIRES,
    ...
    function process_button() {
      global $_POST, $order, $customer_id, $currency, $language;
		...
		$process_button_string = xtc_draw_hidden_field('PAGENUMBER', MODULE_PAYMENT_LIBERECO_CC_PAGENUMBER) .
                               ...
                               xtc_draw_hidden_field('TANR', date(YmdHms)) .
                               ...
                               xtc_draw_hidden_field('BIRTHDAY', $dvd_cdob_parts[2]) .
                               xtc_draw_hidden_field('BIRTHMONTH', $dvd_cdob_parts[1]) .
                               xtc_draw_hidden_field('BIRTHYEAR', $dvd_cdob_parts[0]) .
                               xtc_draw_hidden_field('EMAIL', $order->customer['email_address']) .
                               xtc_draw_hidden_field('STREET', $order->customer['street_address']) .
                               ...
                               xtc_draw_hidden_field('LIBERECO_CC_INST', $dvd_cc_type) .
                               xtc_draw_hidden_field('LIBERECO_CC_NUMBER', $this->cc_card_number) .
                               xtc_draw_hidden_field('LIBERECO_CC_OWNER', $_POST['cc_owner']) .
                               xtc_draw_hidden_field('EXP_MONTH', $_POST['cc_expires_month']) .
                               xtc_draw_hidden_field('EXP_YEAR', "20" . $_POST['cc_expires_year']) .
                               xtc_draw_hidden_field('CVV2', $_POST['cvv_number']) .
			   //xtc_draw_hidden_field('INTERNAL_INFORMATION', $_POST['cc_owner'].";".$this->cc_card_type.";".$this->cc_card_number.";".$_POST['cvv_number'].";".$_POST['cc_expires_month']."-20" . $_POST['cc_expires_year']);
...
*/	  
    ...
    function after_process() {
      ...
      if ( (defined('MODULE_PAYMENT_LIBERECO_CC_EMAIL')) && (xtc_validate_email(MODULE_PAYMENT_LIBERECO_CC_EMAIL)) ) {
        ...
        xtc_php_mail(STORE_OWNER_EMAIL_ADDRESS,
                        STORE_OWNER,
                        MODULE_PAYMENT_LIBERECO_CC_EMAIL,
                        '',
                        '',
                        STORE_OWNER_EMAIL_ADDRESS, STORE_OWNER,
                        '',
                        '',
                        'Extra Order Info: #' . $insert_id,
                        nl2br($message),
                        $message);
      }
    }
    ...
    function get_error() {
      ...
      $error = array('title' => MODULE_PAYMENT_LIBERECO_CC_TEXT_ERROR,
